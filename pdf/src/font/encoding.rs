...
static ZAPFDINGBATS_ENCODING: [&str; 256] = [
    ...
    "a157", "a158", "a159", "a160", "a161", "a163", "a164", "a196", "a165", "a192", "a166", "a167",
    "a168", "a169", "a170", "a171", "a172", "a173", "a162", "a174", "a175", "a176", "a177", "a178",
    "a179", "a193", "a180", "a199", "a181", "a200", "a182", "", "a201", "a183", "a184", "a197",
...
pub fn get_encoding(name: &str) -> HashMap<u32, String> {
    let enc = {
        match name {
    ...
    for (k, item) in enc.iter().enumerate() {
        if item.is_empty() {
            continue;
        }
        encoding.insert(k as u32, item.to_string());
    }
    encoding
}
